      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.messages && Array.isArray(data.messages)) {
            ...
            const displayMessages: Message[] = data.messages.map((msg: any) => ({
              role: msg.role,
              content: msg.content
            }));
  ...
  return (
    <div className="flex flex-col h-full max-w-4xl mx-auto">
      ...
      <div className="flex-shrink-0 flex justify-between items-center px-4 py-3 border-b bg-background">
        <h1 className="text-xl md:text-2xl font-bold">Chat with Daniel McCarthy</h1>
        ...
        {isLoadingHistory ? (
            ...
            <div className="text-center space-y-6 max-w-lg">
              <div>
                ...
                <p className="text-muted-foreground">
                  Ask me about my experience with data platforms, AI engineering, team leadership, or any of my technical projects.
                </p>
              </div>
          ...
          <MessageList 
            ...
            onFeedback={(messageIndex, positive) => {
              ...
              toast({
                title: positive ? "Thanks for your feedback!" : "Feedback received",
